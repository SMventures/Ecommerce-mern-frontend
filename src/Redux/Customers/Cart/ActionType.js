...
export const ADD_MULTIPLE_ITEMS_TO_CART_FAILURE = 'ADD_MULTIPLE_ITEMS_TO_CART_FAILURE';
export const ADD_MULTIPLE_ITEMS_TO_CART_REQUEST = 'ADD_MULTIPLE_ITEMS_TO_CART_REQUEST';
export const ADD_MULTIPLE_ITEMS_TO_CART_SUCCESS = 'ADD_MULTIPLE_ITEMS_TO_CART_SUCCESS';

export const UPDATE_CART_TOTAL = 'UPDATE_CART_TOTAL'; // Added the UPDATE_CART_TOTAL action type
